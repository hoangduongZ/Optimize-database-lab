...
SELECT COUNT(*) FROM orders; -- 12,000,000 dòng
SELECT id,product_id,variant_id,warehouse_id,quantity_available,quantity_reserved,low_stock_threshold,version,last_updated FROM inventory_items;
-- ============================================================
-- PROBLEM: lấy toàn bộ đơn hàng của 1 khách hàng.
-- orders có 12,000,000 dòng, customer_id chưa có index (chỉ có PK trên id).
-- ============================================================
